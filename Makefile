...
# JsHint STDOUT test
log/jshint.log: log/npm-dev-install.log lib/appBox.js test/appBox-test.js
	${JSHINT} lib/appBox.js test/appBox-test.js | tee log/jshint.log ; exit $${PIPESTATUS[0]}

# Mocha BDD STDOUT test
log/mocha.log: log/npm-dev-install.log lib/appBox.js test/appBox-test.js
	${MOCHA} test/appBox-test.js -R spec | tee log/mocha.log ; exit $${PIPESTATUS[0]}
...
bdd-spec.md: log/npm-dev-install.log lib/appBox.js test/appBox-test.js
	${MOCHA} test/appBox-test.js -R markdown > bdd-spec.md

# Upgrade version in package.json
log/upgrade-package.log: lib/appBox.js test/appBox-test.js documentation.md
...
log/github-push.log: lib/appBox.js test/appBox-test.js package.json
